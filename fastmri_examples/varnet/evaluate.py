...
def evaluate(args, recons_key):
    ...
    for tgt_file in tqdm(args.target_path.iterdir(), total=len(list(args.target_path.iterdir()))):
        if not os.path.isfile(args.predictions_path / tgt_file.name):
            # print(f"Skipping {tgt_file.name} as it does not have a corresponding reconstruction")
            continue
